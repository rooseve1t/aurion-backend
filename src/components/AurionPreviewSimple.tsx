...
export function AurionPreviewSimple() {
  ...
  const modules = [
    { id: 'overview', name: 'Обзор', icon: '🏠', color: 'blue' },
    { id: 'voice', name: 'Голос JARVIS', icon: '🎤', color: 'purple' },
    { id: 'quantum', name: 'Квантовые вычисления', icon: '⚛️', color: 'cyan' },
    { id: 'memory', name: 'Векторная память', icon: '🧠', color: 'green' },
    { id: 'osint', name: 'OSINT разведка', icon: '🔍', color: 'orange' },
    { id: 'finance', name: 'Финансы', icon: '💰', color: 'yellow' },
    { id: 'smarthome', name: 'Умный дом', icon: '🏠', color: 'indigo' },
    { id: 'agents', name: 'Агенты', icon: '🤖', color: 'pink' }
  ]
              ...
              <button
                ...
                className={`flex items-center space-x-2 px-4 py-2 rounded-lg transition-all duration-200 whitespace-nowrap ${
                  activeModule === module.id
                    ? `bg-gradient-to-r ${getColorClasses(module.color)} text-white shadow-lg`
